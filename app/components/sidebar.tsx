    ...
    <div className="group fixed inset-y-0 left-0 z-20 flex h-full flex-col border-r bg-background transition-all duration-300 w-[70px] hover:w-64 lg:w-64">
      ...
      <nav className="grid gap-1 px-2 pt-2 group-hover:px-2 lg:px-2">
        ...
        <Link
          ...
          className={cn(
            "flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium hover:bg-accent hover:text-accent-foreground",
            isActive("/customers") && "bg-accent text-accent-foreground",
          )}
        >
        ...
        <Link
          ...
          className={cn(
            "flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium hover:bg-accent hover:text-accent-foreground",
            isActive("/campaigns") && "bg-accent text-accent-foreground",
          )}
        >
        ...
        <Link
          ...
          className={cn(
            "flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium hover:bg-accent hover:text-accent-foreground",
            isActive("/email-marketing") && "bg-accent text-accent-foreground",
          )}
        >
        ...
        <Link
          ...
          className={cn(
            "flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium hover:bg-accent hover:text-accent-foreground",
            isActive("/social-media") && "bg-accent text-accent-foreground",
          )}
        >
        ...
        <Link
          ...
          className={cn(
            "flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium hover:bg-accent hover:text-accent-foreground",
            isActive("/notifications") && "bg-accent text-accent-foreground",
          )}
        >
        ...
        <Link
          ...
          className={cn(
            "flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium hover:bg-accent hover:text-accent-foreground",
            isActive("/settings/compliance") && "bg-accent text-accent-foreground",
          )}
        >
        ...
        <Link
          ...
          className={cn(
            "flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium hover:bg-accent hover:text-accent-foreground",
            isActive("/settings") && !isActive("/settings/compliance") && "bg-accent text-accent-foreground",
          )}
        >
